...
`;return h.parse(await n(c,b))}async function n(a,b){let c=function(){let a=process.env.OPENAI_API_KEY?.trim();if(!a)throw Error("AI_NOT_CONFIGURED");return new d.Ay({apiKey:a,timeout:6e4,maxRetries:2})}();try{let d=await c.responses.create({model:process.env.OPENAI_MODEL||"gpt-5",instructions:a,input:b,text:{format:{type:"json_object"}},store:!1});if(!d.output_text?.trim())throw Error("AI_EMPTY_RESPONSE");return JSON.parse(d.output_text)}catch(a){if(a instanceof SyntaxError)throw Error("AI_INVALID_RESPONSE");if(a instanceof Error&&("AI_NOT_CONFIGURED"===a.message||"AI_EMPTY_RESPONSE"===a.message))throw a;throw Error("AI_REQUEST_FAILED")}}}};var b=require("../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[331,889,692,711,676],()=>b(b.s=6601));module.exports=c})();